...
const validate = (properties,body,title,requiredPropertiesToPass) =>{
    ...
    try{
        ...
        if(!errorMessage || objectLength(outPut) >= requiredPropertiesToPass ){ return {passed:true,item:outPut}; }
